  ...
  return (
    <>
      <section className="ff-dashboard-metrics-primary mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
        <Card className="p-5">
          <div className="flex items-center justify-between">
            <p className="text-sm text-[var(--ff-muted-2)]">Treinos</p>
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between">
            <p className="text-sm text-[var(--ff-muted-2)]">Volume total</p>
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between">
            <p className="text-sm text-[var(--ff-muted-2)]">Tempo total</p>
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between">
            <p className="text-sm text-[var(--ff-muted-2)]">PRs</p>
      ...
      <section className="ff-dashboard-metrics-secondary mt-6 grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-4">
        <Card className="p-5">
          <div className="flex items-center justify-between">
            <p className="text-sm text-[var(--ff-muted-2)]">Streak atual</p>
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between">
            <p className="text-sm text-[var(--ff-muted-2)]">Últimos 7 dias</p>
            <CalendarDays size={20} className="text-[var(--ff-accent-text)]" />
          </div>
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between">
            <p className="text-sm text-[var(--ff-muted-2)]">Média por treino</p>
        ...
        <Card className="p-4">
          <div className="flex items-center justify-between">
            <p className="text-sm text-[var(--ff-muted-2)]">Favoritos</p>
            <Trophy size={20} className="text-yellow-400" />
          </div>
      ...
      <section className="ff-dashboard-metrics-secondary mt-5 grid grid-cols-1 gap-5 md:grid-cols-3">
        <Card className="p-5">
          <div className="flex items-center justify-between">
            <p className="text-sm text-[var(--ff-muted-2)]">PRs de peso</p>
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between">
            <p className="text-sm text-[var(--ff-muted-2)]">PRs de volume</p>
            <Flame size={20} className="text-orange-400" />
          </div>
        ...
        <Card className="p-5">
          <div className="flex items-center justify-between">
            <p className="text-sm text-[var(--ff-muted-2)]">Melhor volume em série</p>
            <Weight size={20} className="text-[var(--ff-accent-text)]" />
          </div>
          ...
          {bestVolumeSet ? (
            ...
            <>
              ...
              <p className="mt-2 text-xs text-[var(--ff-muted-2)]">Sem dados ainda</p>
            </>
          )}
        </Card>
      </section>
      ...
      <section className="ff-dashboard-metrics-detail mt-6 grid grid-cols-1 gap-5 xl:grid-cols-2 2xl:grid-cols-3">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:min-w-[360px]">
              <div className="rounded-2xl border border-[var(--ff-border)] bg-[var(--ff-card)] p-4">
                <p className="text-xs text-[var(--ff-muted-2)]">Exercícios</p>
              ...
              <div className="rounded-2xl border border-[var(--ff-border)] bg-[var(--ff-card)] p-4">
                <p className="text-xs text-[var(--ff-muted-2)]">Volume</p>
              ...
              <div className="rounded-2xl border border-[var(--ff-border)] bg-[var(--ff-card)] p-4">
                <p className="text-xs text-[var(--ff-muted-2)]">Duração</p>
                <p className="mt-1 text-xl font-black">
                  {lastSession
        ...
        <Card>
          ...
          <div className="mt-5 flex items-end gap-3">
            ...
            <span className="pb-2 text-sm font-bold text-[var(--ff-muted)]">
              treino(s)
            </span>
          </div>

          <div className="mt-5 rounded-2xl border border-[var(--ff-border)] bg-[var(--ff-card)] p-4">
            <p className="text-xs text-[var(--ff-muted-2)]">Volume médio por treino</p>
          ...
          {consistencyStats.lastWorkoutDate && (
            <p className="mt-3 text-xs text-[var(--ff-muted-2)]">
              Último treino em {formatShortDate(consistencyStats.lastWorkoutDate)}
            </p>
          )}

          <p className="mt-4 text-sm text-[var(--ff-muted-2)]">
