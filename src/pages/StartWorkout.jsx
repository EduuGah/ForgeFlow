                ...
                <div className="space-y-3">
                  {sessionExercise.sets.map((set) => {
                    ...
                    return (
                      <div
                        key={set.id}
                        className={`grid w-full grid-cols-[52px_minmax(120px,1fr)_minmax(120px,1fr)_150px_52px] items-center gap-3 rounded-2xl border p-3 transition max-md:grid-cols-[44px_1fr_1fr_44px] ${
                          set.completed
