          ...
          {sessionExercises.map((sessionExercise, exerciseIndex) => {
            ...
            return (
              ...
              >
                ...
                {!isCollapsed && (
                  <div className="mt-5">
                    <div className="mb-3 grid grid-cols-[40px_minmax(108px,1fr)_minmax(108px,1fr)_44px] gap-2 px-1 text-[10px] font-black uppercase tracking-[0.16em] text-[var(--ff-muted)] sm:grid-cols-[54px_minmax(150px,1fr)_minmax(150px,1fr)_54px] lg:grid-cols-[58px_minmax(170px,1fr)_minmax(170px,1fr)_150px_54px] lg:gap-3 lg:px-3">
                      <span>Série</span>
                      <span>Carga</span>
                      <span>Reps</span>
                    ...
                    <div className="space-y-3 overflow-x-auto pb-1">
                      {(sessionExercise.sets || []).map((set) => {
                        ...
                        return (
                          <div
                            key={set.id}
                            className={`grid w-full grid-cols-[40px_minmax(108px,1fr)_minmax(108px,1fr)_44px] items-center gap-2 rounded-3xl border p-2.5 transition sm:grid-cols-[54px_minmax(150px,1fr)_minmax(150px,1fr)_54px] sm:p-3 lg:grid-cols-[58px_minmax(170px,1fr)_minmax(170px,1fr)_150px_54px] lg:gap-3 ${
                              set.completed
