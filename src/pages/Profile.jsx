        ...
        <div className="space-y-5">
          <div className="overflow-hidden rounded-[2rem] border border-[var(--ff-accent-border)]/25 bg-gradient-to-br from-[var(--ff-accent-soft)]/25 via-[var(--ff-card)] to-[var(--ff-surface-2)] p-5 shadow-[0_18px_44px_rgba(0,0,0,0.24)]">
            <div className="flex items-start justify-between gap-4">
              <div className="flex min-w-0 items-center gap-4">
                <div className="flex h-20 w-20 shrink-0 items-center justify-center overflow-hidden rounded-3xl border border-[var(--ff-accent-border)]/30 bg-[var(--ff-accent-soft)] text-[var(--ff-accent-text)] shadow-[0_0_20px_var(--ff-accent-shadow)]">
                  {profile.avatarUrl ? (
                    <img
                ...
                <div className="min-w-0">
                  <Badge variant="purple">Atleta ForgeFlow</Badge>

                  <h1 className="mt-3 line-clamp-2 text-2xl font-black leading-tight tracking-tight text-[var(--ff-text)]">
                    {profile.name || 'Atleta ForgeFlow'}
                  </h1>

                  <p className="mt-1 line-clamp-2 text-sm text-[var(--ff-muted)]">
            ...
            <div className="mt-5 grid grid-cols-3 gap-3">
              <div className="rounded-3xl border border-[var(--ff-border)] bg-[var(--ff-card)] p-3 text-center">
                ...
                <p className="mt-1 text-[11px] text-[var(--ff-muted)]">kg atual</p>
              </div>
          ...
          <section className="grid grid-cols-2 gap-3">
            <Card className="p-4">
              ...
              <p className="mt-3 text-xs text-[var(--ff-muted)]">Objetivo</p>
              <p className="mt-1 line-clamp-2 text-sm font-black text-[var(--ff-text)]">
            ...
            <Card className="p-4">
              ...
              <p className="mt-3 text-xs text-[var(--ff-muted)]">Altura</p>
              <p className="mt-1 text-sm font-black text-[var(--ff-text)]">
                {profile.height ? `${profile.height} cm` : 'Não definida'}
              </p>
            </Card>

            <Card className="p-4">
              <Dumbbell size={20} className="text-[var(--ff-accent-text)]" />
              <p className="mt-3 text-xs text-[var(--ff-muted)]">Meta semanal</p>
              <p className="mt-1 text-sm font-black text-[var(--ff-text)]">
            ...
            <Card className="p-4">
              <Medal size={20} className="text-[var(--ff-accent-text)]" />
              <p className="mt-3 text-xs text-[var(--ff-muted)]">Nível</p>
              <p className="mt-1 text-sm font-black text-[var(--ff-text)]">
                {profile.experience || 'Não definido'}
              </p>
            </Card>
          </section>
          ...
          <Card className="p-4">
            <div className="flex items-center justify-between gap-3">
              ...
              {lastWeightRecord && (
                <Badge>{formatShortDate(lastWeightRecord.date)}</Badge>
              )}
            </div>

            <form onSubmit={handleAddWeight} className="mt-4 grid grid-cols-[1fr_120px] gap-2">
              <Input
                label="Peso"
                type="number"
                step="0.1"
              ...
              <Input
                ...
                value={dateInput}
                onClick={() => {
                  if (settings.autoOpenCalendar) dateInputRef.current?.showPicker?.()
                }}
          ...
          <Card className="p-4">
            ...
            <div className="mt-4 space-y-3">
              <div className="rounded-2xl border border-[var(--ff-border)] bg-[var(--ff-surface-2)] p-3">
                <p className="text-xs text-[var(--ff-muted)]">Exercício mais treinado</p>
                <p className="mt-1 line-clamp-1 font-black text-[var(--ff-text)]">
                  {mostTrainedExercise?.exerciseName || 'Sem dados'}
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-[var(--ff-border)] bg-[var(--ff-surface-2)] p-3">
                ...
                <p className="mt-1 line-clamp-1 font-black text-[var(--ff-text)]">
                  {heaviestExercise
                    ? `${heaviestExercise.exerciseName} • ${heaviestExercise.weight}kg`
                    : 'Sem dados'}
                </p>
              </div>

              <div className="rounded-2xl border border-[var(--ff-border)] bg-[var(--ff-surface-2)] p-3">
                <p className="text-xs text-[var(--ff-muted)]">Variação de peso</p>
                <p className="mt-1 font-black text-[var(--ff-text)]">
                  {weightDifference ? `${weightDifference} kg` : 'Sem dados suficientes'}
                </p>
              </div>
            </div>
          </Card>
