...
const dashboardSteps = [
  ...
  step({
    ...
    description: 'O Dashboard mostra uma ação útil sem inventar recomendação quando ainda não há dados suficientes.',
  ...
  step({
    ...
    example: 'Na primeira conta, alguns cards aparecem como estado inicial até você registrar dados reais.',
    target: '[data-tutorial="dashboard-summary"], [data-tutorial="dashboard-insights"]',
    route: '/',
    placement: 'top',
    requireElement: true,
    targetLabel: 'Resumo',
...
const workoutSteps = [
  step({
    ...
    target: '[data-tutorial="active-workout-header"], [data-tutorial="active-workout-timer"]',
    route: '/start-workout',
    placement: 'bottom',
    requireElement: true,
...
const historySteps = [
  step({
    ...
    example: 'Em conta nova, esta área pode aparecer vazia até você finalizar o primeiro treino real.',
    target: '[data-tutorial="history-list"], [data-tutorial="history-volume"]',
    route: '/history',
    placement: 'top',
    requireElement: true,
...
const progressSteps = [
  step({
    ...
    description: 'A evolução mostra gráficos, volume, frequência e PRs quando já existe histórico suficiente.',
    example: 'Em conta nova, é normal aparecer um estado vazio até você finalizar alguns treinos.',
    target: '[data-tutorial="progress-overview"], [data-tutorial="progress-chart"], [data-tutorial="progress-prs"]',
    route: '/progress',
    placement: 'top',
    optional: true,
...
const nutritionSteps = [
  step({
    ...
    example: 'Use os botões rápidos para editar sem descer a página inteira.',
